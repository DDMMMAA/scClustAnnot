...
`scClustAnnot` contain one buildin scRNA-seq data. This is the same data as `Seurat` vignettes. The reason of choice same data as `Seuart` is because this package is heavyly based on `Seurat`.
